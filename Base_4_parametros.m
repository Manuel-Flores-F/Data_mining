...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%    Vamos a aplicar , la eliminación de filas repetidas
%%%%%%    En la matrz Train y En la Matriz Test
%%%%%%    Veremos que cambios se generan a partir de ello
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Train(:,[1,6,7,8,9,10]) = []
Test(:,[1,6,7,8,9,10]) = []
...
Conteo_M2 = [Conteo_M(:,1),Conteo_M(:, 2:5) + 1];
Conteo_B2 = [Conteo_B(:,1),Conteo_B(:, 2:5) + 1];
...
Conteo_M_Norm = [Conteo_M(:,1),Conteo_M2(:, 2:5)/NormFac_M];
Conteo_B_Norm = [Conteo_B(:,1),Conteo_B2(:, 2:5)/NormFac_B];
